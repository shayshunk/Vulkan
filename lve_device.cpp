...
std::vector<char const*> LveDevice::getRequiredExtensions()
{
...
VkFormat
LveDevice::findSupportedFormat(std::vector<VkFormat> const& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
void LveDevice::createImageWithInfo(VkImageCreateInfo const& imageInfo,
                                    VkMemoryPropertyFlags properties,
                                    VkImage& image,
