...
VkSurfaceFormatKHR LveSwapChain::ChooseSwapSurfaceFormat(std::vector<VkSurfaceFormatKHR> const& availableFormats)
{
...
VkPresentModeKHR LveSwapChain::ChooseSwapPresentMode(std::vector<VkPresentModeKHR> const& availablePresentModes)
{
...
VkExtent2D LveSwapChain::ChooseSwapExtent(VkSurfaceCapabilitiesKHR const& capabilities)
{
